...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__states_Boot__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__states_Load__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__states_Play__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__states_Menu__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__states_Win__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__states_Lose__ = __webpack_require__(134);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  constructor() {
    super(1200, 720, __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.AUTO, '');

    this.state.add('Boot', __WEBPACK_IMPORTED_MODULE_3__states_Boot__["a" /* default */]);
    this.state.add('Win', __WEBPACK_IMPORTED_MODULE_7__states_Win__["a" /* default */]);
    this.state.add('Lose', __WEBPACK_IMPORTED_MODULE_8__states_Lose__["a" /* default */]);
    this.state.add('Load', __WEBPACK_IMPORTED_MODULE_4__states_Load__["a" /* default */]);
    this.state.add('Play', __WEBPACK_IMPORTED_MODULE_5__states_Play__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);


class Player extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Sprite {
...
class Boot extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  init() {
...
class Load extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  preload() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_phaser_state_transition__ = __webpack_require__(66);



class Menu extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  create() {
    this.EnteringTransition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_phaser_state_transition__["a" /* createTransition */])({ props: { alpha: 0.5 } });
    this.add.text(100, 100, 'Game over! Press space to restart game', { fill: '#fff' });
    this.spaceKey = this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.SPACEBAR);
...
class Menu extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  create() {
    this.EnteringTransition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_phaser_state_transition__["a" /* createTransition */])({ props: { alpha: 0.5 } });
    this.add.text(100, 100, 'Press space to start the game', { fill: '#fff' });
    this.spaceKey = this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.SPACEBAR);
    this.spaceKey.onDown.add(this.startGame, this);
  }
  startGame() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_phaser_state_transition__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sprites_Player__ = __webpack_require__(131);




class Play extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  create() {
    // SET TRANSITION
    this.stateTransition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_phaser_state_transition__["a" /* createTransition */])({
      props: {
    ...
    // SET PLAYER
    this.player = new __WEBPACK_IMPORTED_MODULE_2__sprites_Player__["a" /* default */]({ game: this.game, x: 600, y: 720, asset: 'player' });
    ...
    this.game.physics.enable(this.food, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
    var _this = this;
    for (let i = 0; i < 64; i++) {
      (function (i) {
        setTimeout(function () {
